...
type ModelSpec struct {
	...
	// protocol selects the request format independently of the provider name.
	// Supported values are "openai", "anthropic", and "google". When omitted,
	// AX infers Google and Anthropic from provider and uses OpenAI-compatible
	// chat completions for every other provider name.
	Protocol string `protobuf:"bytes,8,opt,name=protocol,proto3" json:"protocol,omitempty"`
	// base_url is the API base URL, including any version path such as /v1.
	// AX adds the protocol's request path unless the full path is already present.
	BaseUrl string `protobuf:"bytes,9,opt,name=base_url,json=baseURL,proto3" json:"base_url,omitempty"`
	// headers adds non-secret headers to each request, for example OpenRouter
	// attribution headers. Use secret_key for credentials instead.
	...
	// api_key_header and api_key_prefix override the protocol's default API-key
	// authentication. A custom header defaults to no prefix.
	ApiKeyHeader  string `protobuf:"bytes,11,opt,name=api_key_header,json=apiKeyHeader,proto3" json:"api_key_header,omitempty"`
	ApiKeyPrefix  string `protobuf:"bytes,12,opt,name=api_key_prefix,json=apiKeyPrefix,proto3" json:"api_key_prefix,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ModelSpec) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
func (x *ModelSpec) GetHeaders() map[string]string {
	if x != nil {
		return x.Headers
	}
	return nil
...
func (x *ModelSpec) GetApiKeyHeader() string {
	if x != nil {
...
func (x *ModelSpec) GetApiKeyPrefix() string {
	if x != nil {
...
const file_pkg_apis_v1alpha1_ax_proto_rawDesc = "" +
	...
	"\x04kind\x18\x02 \x01(\tR\x04kind\x123\n" +
	"\bmetadata\x18\x03 \x01(\v2\x17.ax.v1alpha1.ObjectMetaR\bmetadata\x12*\n" +
	"\x04spec\x18\x04 \x01(\v2\x16.ax.v1alpha1.ModelSpecR\x04spec\"\xed\x03\n" +
	"\tModelSpec\x12\x1a\n" +
	...
	"parameters\x12\x1a\n" +
	"\bprotocol\x18\b \x01(\tR\bprotocol\x12\x19\n" +
	"\bbase_url\x18\t \x01(\tR\abaseURL\x12=\n" +
	"\aheaders\x18\n" +
	" \x03(\v2#.ax.v1alpha1.ModelSpec.HeadersEntryR\aheaders\x12$\n" +
	"\x0eapi_key_header\x18\v \x01(\tR\fapiKeyHeader\x12$\n" +
	"\x0eapi_key_prefix\x18\f \x01(\tR\fapiKeyPrefix\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06R\vtemperatureR\n" +
...
var file_pkg_apis_v1alpha1_ax_proto_goTypes = []any{
	...
	nil,                             // 57: ax.v1alpha1.ModelSpec.HeadersEntry
...
var file_pkg_apis_v1alpha1_ax_proto_depIdxs = []int32{
	...
	59, // 33: ax.v1alpha1.ModelSpec.parameters:type_name -> google.protobuf.Struct
	57, // 34: ax.v1alpha1.ModelSpec.headers:type_name -> ax.v1alpha1.ModelSpec.HeadersEntry
	1,  // 35: ax.v1alpha1.ListTasksResponse.tasks:type_name -> ax.v1alpha1.Task
	1,  // 36: ax.v1alpha1.UpdateTaskRequest.task:type_name -> ax.v1alpha1.Task
	1,  // 37: ax.v1alpha1.WatchTaskResponse.task:type_name -> ax.v1alpha1.Task
	12, // 38: ax.v1alpha1.ListGatewaysResponse.gateways:type_name -> ax.v1alpha1.Gateway
	12, // 39: ax.v1alpha1.UpdateGatewayRequest.gateway:type_name -> ax.v1alpha1.Gateway
	18, // 40: ax.v1alpha1.ListWorkspacesResponse.workspaces:type_name -> ax.v1alpha1.Workspace
	18, // 41: ax.v1alpha1.UpdateWorkspaceRequest.workspace:type_name -> ax.v1alpha1.Workspace
	26, // 42: ax.v1alpha1.ListModelsResponse.models:type_name -> ax.v1alpha1.Model
	26, // 43: ax.v1alpha1.UpdateModelRequest.model:type_name -> ax.v1alpha1.Model
	29, // 44: ax.v1alpha1.AX.GetTask:input_type -> ax.v1alpha1.GetTaskRequest
	30, // 45: ax.v1alpha1.AX.ListTasks:input_type -> ax.v1alpha1.ListTasksRequest
	32, // 46: ax.v1alpha1.AX.UpdateTask:input_type -> ax.v1alpha1.UpdateTaskRequest
	33, // 47: ax.v1alpha1.AX.DeleteTask:input_type -> ax.v1alpha1.DeleteTaskRequest
	35, // 48: ax.v1alpha1.AX.SuspendTask:input_type -> ax.v1alpha1.SuspendTaskRequest
	36, // 49: ax.v1alpha1.AX.ResumeTask:input_type -> ax.v1alpha1.ResumeTaskRequest
	37, // 50: ax.v1alpha1.AX.WatchTask:input_type -> ax.v1alpha1.WatchTaskRequest
	39, // 51: ax.v1alpha1.AX.GetGateway:input_type -> ax.v1alpha1.GetGatewayRequest
	40, // 52: ax.v1alpha1.AX.ListGateways:input_type -> ax.v1alpha1.ListGatewaysRequest
	42, // 53: ax.v1alpha1.AX.UpdateGateway:input_type -> ax.v1alpha1.UpdateGatewayRequest
	43, // 54: ax.v1alpha1.AX.DeleteGateway:input_type -> ax.v1alpha1.DeleteGatewayRequest
	45, // 55: ax.v1alpha1.AX.GetWorkspace:input_type -> ax.v1alpha1.GetWorkspaceRequest
	46, // 56: ax.v1alpha1.AX.ListWorkspaces:input_type -> ax.v1alpha1.ListWorkspacesRequest
	48, // 57: ax.v1alpha1.AX.UpdateWorkspace:input_type -> ax.v1alpha1.UpdateWorkspaceRequest
	49, // 58: ax.v1alpha1.AX.DeleteWorkspace:input_type -> ax.v1alpha1.DeleteWorkspaceRequest
	51, // 59: ax.v1alpha1.AX.GetModel:input_type -> ax.v1alpha1.GetModelRequest
	52, // 60: ax.v1alpha1.AX.ListModels:input_type -> ax.v1alpha1.ListModelsRequest
	54, // 61: ax.v1alpha1.AX.UpdateModel:input_type -> ax.v1alpha1.UpdateModelRequest
	55, // 62: ax.v1alpha1.AX.DeleteModel:input_type -> ax.v1alpha1.DeleteModelRequest
	1,  // 63: ax.v1alpha1.AX.GetTask:output_type -> ax.v1alpha1.Task
	31, // 64: ax.v1alpha1.AX.ListTasks:output_type -> ax.v1alpha1.ListTasksResponse
	1,  // 65: ax.v1alpha1.AX.UpdateTask:output_type -> ax.v1alpha1.Task
	34, // 66: ax.v1alpha1.AX.DeleteTask:output_type -> ax.v1alpha1.DeleteTaskResponse
	1,  // 67: ax.v1alpha1.AX.SuspendTask:output_type -> ax.v1alpha1.Task
	1,  // 68: ax.v1alpha1.AX.ResumeTask:output_type -> ax.v1alpha1.Task
	38, // 69: ax.v1alpha1.AX.WatchTask:output_type -> ax.v1alpha1.WatchTaskResponse
	12, // 70: ax.v1alpha1.AX.GetGateway:output_type -> ax.v1alpha1.Gateway
	41, // 71: ax.v1alpha1.AX.ListGateways:output_type -> ax.v1alpha1.ListGatewaysResponse
	12, // 72: ax.v1alpha1.AX.UpdateGateway:output_type -> ax.v1alpha1.Gateway
	44, // 73: ax.v1alpha1.AX.DeleteGateway:output_type -> ax.v1alpha1.DeleteGatewayResponse
	18, // 74: ax.v1alpha1.AX.GetWorkspace:output_type -> ax.v1alpha1.Workspace
	47, // 75: ax.v1alpha1.AX.ListWorkspaces:output_type -> ax.v1alpha1.ListWorkspacesResponse
	18, // 76: ax.v1alpha1.AX.UpdateWorkspace:output_type -> ax.v1alpha1.Workspace
	50, // 77: ax.v1alpha1.AX.DeleteWorkspace:output_type -> ax.v1alpha1.DeleteWorkspaceResponse
	26, // 78: ax.v1alpha1.AX.GetModel:output_type -> ax.v1alpha1.Model
	53, // 79: ax.v1alpha1.AX.ListModels:output_type -> ax.v1alpha1.ListModelsResponse
	26, // 80: ax.v1alpha1.AX.UpdateModel:output_type -> ax.v1alpha1.Model
	56, // 81: ax.v1alpha1.AX.DeleteModel:output_type -> ax.v1alpha1.DeleteModelResponse
